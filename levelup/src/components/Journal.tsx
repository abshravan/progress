...
export default function Journal({ journal, profile, onUpdate, onXPGain }: Props) {
  ...
  return (
    <div>
      ...
      {/* Stats bar */}
      {journal.length > 0 && (
        <div className="rounded-xl border border-[var(--border-light)] bg-[var(--card)] p-5 mb-6 card-hover">
              ...
              <div className="space-y-2">
                {entries.map((entry) => {
                  ...
                  return (
                    <div
                      key={entry.id}
                      className="rounded-xl border border-[var(--border-light)] bg-[var(--card)] group card-hover"
                    >
                      <div className="p-5">
                        {/* Entry header */}
                        <div className="flex items-center justify-between mb-3">
